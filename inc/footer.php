       ...
       <div class="container-fliud bg-white mt-5">
            <div class="row">
                ...
                <div class="col-lg-4 p-4">
                    ...
                    <a href="#" class=" d-inline-block mb-3 text-dark text-decoration-none">About us</a>
                </div>
                <div class="col-lg-4 p-4">
        ...
        <h6 class=" bg-dark text-center text-white p-3 m-0">Designed and Developed By Forson</h6>
